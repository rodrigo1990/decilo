	  ...
	  <div class="col l10 m10">
		 	<div class="row cont-gral">
				...
				<form action="" style="padding-bottom: 100px;">
					...
					<a class="waves-effect waves-light btn" onClick="insertarEgreso();" style="cursor:pointer;">Ingresar</a>
				</form>
...
<script>
	function insertarEgreso(){
		...
		$.ajax({
				...
				url:'ajax/insertarEgreso.php',
				type:'post',
				success:function(response){

					alert("El egreso ha sido insertado correctamente");
